...
<RangeCalendarPrimitive.Root
	...
	class={cn(
		'group/calendar rounded-2xl border-2 border-border bg-card p-3 shadow-[0_4px_0_0_var(--shadow-3d)] [--cell-radius:0.75rem] [--cell-size:--spacing(9)] [[data-slot=card-content]_&]:border-0 [[data-slot=card-content]_&]:bg-transparent [[data-slot=card-content]_&]:p-0 [[data-slot=card-content]_&]:shadow-none [[data-slot=popover-content]_&]:border-0 [[data-slot=popover-content]_&]:bg-transparent [[data-slot=popover-content]_&]:p-0 [[data-slot=popover-content]_&]:shadow-none',
		className
	)}
	{locale}
	{monthFormat}
