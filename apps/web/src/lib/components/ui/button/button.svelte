<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default:
					'bg-primary text-primary-foreground border-primary shadow-[0_5px_0_0_var(--shadow-3d-primary)] hover:brightness-105 active:not-aria-[haspopup]:shadow-[0_1px_0_0_var(--shadow-3d-primary)]',
				outline:
					'border-border bg-background text-foreground shadow-[0_5px_0_0_var(--shadow-3d)] hover:bg-muted hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground active:not-aria-[haspopup]:shadow-[0_1px_0_0_var(--shadow-3d)]',
				secondary:
					'bg-secondary text-secondary-foreground border-secondary shadow-[0_5px_0_0_var(--shadow-3d-secondary)] hover:brightness-105 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground active:not-aria-[haspopup]:shadow-[0_1px_0_0_var(--shadow-3d-secondary)]',
				ghost:
				...
				destructive:
					'bg-destructive text-white border-destructive shadow-[0_5px_0_0_var(--shadow-3d-destructive)] hover:brightness-105 focus-visible:ring-destructive/30 dark:focus-visible:ring-destructive/40 active:not-aria-[haspopup]:shadow-[0_1px_0_0_var(--shadow-3d-destructive)]',
