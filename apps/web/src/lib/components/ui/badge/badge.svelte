<script lang="ts" module>
	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				default:
					'bg-primary text-primary-foreground border-primary shadow-[0_2px_0_0_var(--shadow-3d-primary)] [a]:hover:brightness-105',
				secondary:
					'bg-secondary text-secondary-foreground border-secondary shadow-[0_2px_0_0_var(--shadow-3d-secondary)] [a]:hover:brightness-105',
				destructive:
					'bg-destructive text-white border-destructive shadow-[0_2px_0_0_var(--shadow-3d-destructive)] [a]:hover:brightness-105 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40',
				outline:
					'border-border text-foreground shadow-[0_2px_0_0_var(--shadow-3d)] [a]:hover:bg-muted [a]:hover:text-muted-foreground',
				ghost:
